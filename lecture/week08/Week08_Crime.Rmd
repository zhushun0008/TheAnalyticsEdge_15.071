...
### VIDEO 03 - A Basic Line Plot


```{r}

# Load our data:
mvt = read.csv("F:/SkyDrive/Studying/MIT_COURSES/15-071-TheAnalyticsEdge/lecture/dataset/mvt.csv", stringsAsFactors=FALSE)
...
# Create our plot 
# group = 1 means one line for this whole data
...
### VIDEO 04 - Adding the Hour of the Day
...
### VIDEO 06 - Geographical Map on US

```{r}

# Load our data:
murders = read.csv("F:/SkyDrive/Studying/MIT_COURSES/15-071-TheAnalyticsEdge/lecture/dataset/murders.csv")
